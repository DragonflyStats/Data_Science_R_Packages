...
The cffdrs package allows R users to calculate the outputs of the two main components of the Cana- dian Forest Fire Danger Rating System (CFFDRS; http://cwfis.cfs.nrcan.gc.ca/background/
...
The FBP System (Forestry Canada Fire Danger Group 1992; Hirsch 1996) provides a set of primary and secondary measures of fire behavior. The primary outputs consist of estimates of fire spread rate, fuel consumption, fire intensity, and fire description (i.e., surface, intermittent, or crown fire).
